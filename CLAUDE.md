...
*Last updated: 2026-07-06 · Owner: Kurtis (kurtis@triplecitiestech.com)*
...
| Sales calculator | `src/lib/sales-calculator/` + `src/config/sales-calculator/` | Internal quoting tool at `/admin/sales-calculator`. Money = `pricing.json` defaults + DB overrides (`sales_calc_pricing_overrides`, edited at `/admin/sales-calculator/pricing`) — never edit the calc code for pricing |
