...
| Sales calculator | `src/lib/sales-calculator/` + `src/config/sales-calculator/` | Internal quoting tool at `/admin/sales-calculator`; `pricing.json` is the single source of truth for money — edit the JSON, never the calc code |
