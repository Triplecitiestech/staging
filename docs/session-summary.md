...
> **Last updated**: 2026-07-05 (later session). Exchange Online automation: mailbox conversion + delegate access now execute for enabled tenants via an Azure Automation runner, verified-observed-state only; keep_accessible defers license removal in all paths.
