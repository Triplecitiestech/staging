...
> **Last updated**: 2026-07-06. Managed Services Sales Calculator integrated as an auth-gated internal route at `/admin/sales-calculator` — standalone app copied verbatim (pricing/logic unchanged), theme fully scoped, all quote math verified.
