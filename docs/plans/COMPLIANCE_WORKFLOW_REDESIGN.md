...
| W3 | ✅ Author `customer_profile` schema in question engine (done 2026-05-13) | `src/lib/compliance/customer-profile-schema.ts` |
| W4 | ✅ `form_responses` table + dual-write + backfill endpoint (done 2026-05-13) | `src/lib/compliance/ensure-tables.ts`, `customer-profile-schema.ts`, `src/app/api/migrations/customer-profile-backfill/route.ts` |
| W5 | ✅ Engine N/A logic reads consolidated profile (done 2026-05-13) | `src/lib/compliance/engine.ts` |
| W6 | ✅ Policy generator reads consolidated profile (done 2026-05-13) | `src/app/api/compliance/policies/generate/route.ts` |
