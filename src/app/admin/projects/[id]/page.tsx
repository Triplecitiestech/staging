    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          {/* Main Info */}
          <div className="lg:col-span-2 bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-white/10 rounded-lg p-6 flex flex-col">
          ...
          <div className="space-y-6">
            ...
            <Link
              href={`/admin/preview/${project.company.slug}?project=${project.id}`}
              target="_blank"
      ...
      <AIProjectAssistant
        ...
        projectContext={{
          ...
          phases: project.phases.map(ph => ({
            title: ph.title,
            status: ph.status,
            tasks: ph.tasks.map(t => ({ taskText: t.taskText, status: t.status })),
          })),
        }}
      />
    </div>
