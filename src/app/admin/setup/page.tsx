  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full bg-gray-800 rounded-lg shadow-2xl p-8 border border-gray-700">
        ...
        {status === 'success' && (
          <div className="mt-6 p-4 bg-violet-900/30 border border-violet-500/50 rounded-lg">
            <p className="text-sm font-semibold text-violet-300 mb-2">Security Reminder:</p>
            <p className="text-sm text-violet-200">
              After migration succeeds, delete these files for security:
            </p>
            <ul className="mt-2 text-xs text-violet-200 space-y-1 ml-4">
