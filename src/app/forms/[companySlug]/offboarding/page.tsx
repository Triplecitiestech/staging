...
export default async function OffboardingFormPage({
  params,
}: {
  ...
  if (!session || session.companySlug !== companySlug) {
    const returnTo = `/forms/${companySlug}/offboarding`
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-gray-900 border border-white/10 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-400 text-sm">
            Only authorized managers can submit employee offboarding requests. Please contact your manager or Triple Cities Tech for assistance.
          </p>
