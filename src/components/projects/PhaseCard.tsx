        ...
        <>
          ...
          {!editing && (phase.customerNotes || phase.internalNotes) && (
            <div className="space-y-3 pt-3 border-t border-white/10">
              ...
              {phase.internalNotes && (
                <div className="bg-violet-500/10 border-l-4 border-violet-500 rounded px-3 py-2">
                  <div className="flex items-center gap-2 mb-1">
                    <svg className="w-4 h-4 text-violet-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span className="text-xs font-semibold text-violet-300 uppercase tracking-wide">Internal Only</span>
                  </div>
