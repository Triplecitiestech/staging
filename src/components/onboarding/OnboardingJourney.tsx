...
const STEPS = [
  ...
  {
    title: 'Action Items',
    description: 'Tasks marked "Waiting on You" need your attention. You can add notes to any task by expanding it and typing in the message box. We\'ll be notified immediately.',
    icon: (
