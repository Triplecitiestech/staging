    ...
    <div className="space-y-8">
      ...
      {viewMode === 'horizontal' && (
        <div className="relative pb-8 pt-16">
          ...
          <button
            onClick={scrollLeft}
            className="absolute -left-14 top-[142px] z-20 w-10 h-10 bg-cyan-500 hover:bg-cyan-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all"
          ...
          <button
            onClick={scrollRight}
            className="absolute -right-14 top-[142px] z-20 w-10 h-10 bg-cyan-500 hover:bg-cyan-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all"
