        ...
        <div className="sticky top-0 z-[60] bg-violet-600/95 backdrop-blur-sm border-b border-violet-400/30 px-4 py-2">
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-3">
            ...
            <span className="text-sm text-white font-medium">
              {impersonation.targetEmail === 'No contacts on file' ? (
                <>Viewing <span className="font-bold">{impersonation.targetName}</span> portal as <span className="font-bold">{impersonation.adminName}</span> (no contacts on file)</>
              ) : (
