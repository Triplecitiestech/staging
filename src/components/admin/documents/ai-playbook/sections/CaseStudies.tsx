  ...
  return (
    <section id="cases" className="pt-20 scroll-mt-8">
      ...
      <div className="rounded-2xl border border-cyan-400/30 bg-cyan-400/[0.06] p-6 my-5">
        ...
        <h4 className="text-[19px] font-bold text-white tracking-tight mb-2">Brooms Over Broome — call-log automation</h4>
        ...
        <Link
          href="/admin/documents/ai-playbook/case-studies/brooms-over-broome"
          className="inline-flex items-center gap-1.5 mt-4 text-sm font-semibold text-cyan-300 hover:text-cyan-200"
        >
      ...
      <Callout open label={<><span className="px-2 py-0.5 rounded-full bg-rose-400/16 text-rose-400 text-[10.5px] font-bold uppercase tracking-wide border border-rose-400/30">Action item</span> Formalize the rest into one-pagers</>}>
        <CalloutP>
          Brooms Over Broome is the first written win. Turn the examples below into one-pagers too — split into <strong className="text-white font-semibold">everyday-usage stories</strong> (to sell managed services) and <strong className="text-white font-semibold">app / project stories</strong> (to sell development).
        </CalloutP>
      </Callout>
