...
const ITEMS: React.ReactNode[] = [
  ...
  <><strong className="text-white font-semibold">Build the assessment report template + Business Snapshot intake form</strong> so every assessment is repeatable and on-brand. The <Link href="/admin/documents/ai-playbook/roi" className="text-cyan-400 hover:text-cyan-300 underline underline-offset-2">ROI calculator</Link> and monthly-waste calculator are live.</>,
  <><strong className="text-white font-semibold">Stand up the AI Services Agreement</strong> (scope, pricing, liability, implementation-period waiver) with local counsel — to attach when a client moves from assessment to engagement. The <Link href="/admin/documents/ai-playbook/aup" className="text-cyan-400 hover:text-cyan-300 underline underline-offset-2">AI Acceptable Use Policy</Link> template is already drafted.</>,
