        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { href: '/admin/reporting/wan-reliability', label: 'Site Connectivity & Stability', desc: 'Outages, uptime & failover events — live from Domotz' },
              { href: '/admin/reporting/delivery-economics', label: 'Delivery Economics & Capacity', desc: 'Cost to serve per billed unit, margin & headroom — internal only' },
