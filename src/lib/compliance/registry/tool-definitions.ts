...

  {
    ...
    capabilities: [
      { capabilityId: 'saas_security_monitoring', confidence: 'authoritative',
        ...
        evidenceSourceTypes: ['saas_alerts_monitoring', 'saas_alerts_recommended_actions'] },
      ...
      { capabilityId: 'audit_logging', confidence: 'supplementary',
        ...
        evidenceSourceTypes: ['saas_alerts_monitoring'] },
      { capabilityId: 'device_compliance', confidence: 'supplementary',
        dataDescription: 'Unify module — tracks which SaaS users access from managed vs unmanaged devices; surfaces unmapped device-to-identity relationships',
        evidenceSourceTypes: ['saas_alerts_device_identity'] },
      { capabilityId: 'conditional_access', confidence: 'supplementary',
        dataDescription: 'Unify module — enforces SaaS access only from devices bound to a known identity',
        evidenceSourceTypes: ['saas_alerts_device_identity'] },
    ],
  },
