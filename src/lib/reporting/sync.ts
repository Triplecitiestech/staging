 ...
 * Only fetches entries for tickets modified since last sync.
 */
export async function syncTimeEntries(): Promise<TimeEntrySyncResult> {
 ...
 */
export async function syncTicketNotes(): Promise<NoteSyncResult> {
